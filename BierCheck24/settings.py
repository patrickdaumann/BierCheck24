"""
Django settings for BierCheck24 project.
...
WSGI_APPLICATION = 'BierCheck24.wsgi.application'
...
# Pfad zu den statischen Dateien während der Entwicklung
STATIC_URL = '/static/'
